    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {benefits.map((benefit) => (
              <div 
                key={benefit.title}
                className="bg-card border border-border/50 rounded-2xl p-6 hover:shadow-xl hover:border-primary/20 transition-all duration-300"
              >
        ...
        <div className="mt-20 text-center">
          <p className="text-sm text-muted-foreground mb-8">Trusted by leading educational institutions</p>
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-60">
            {['IIT Delhi', 'NIT Trichy', 'BITS Pilani', 'VIT University', 'Amity University'].map((name) => (
